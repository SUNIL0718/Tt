      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-lg font-bold tracking-tight text-gray-900">TimetableAI</span>
          </div>
          <p className="text-center text-xs leading-5 text-gray-500 md:text-left">
            &copy; 2026 TimetableAI, Inc. All rights reserved.
          </p>
        </div>
        <div className="mt-8 grid grid-cols-2 gap-8 md:order-3 md:mt-0">
          <div>
            ...
            <ul role="list" className="mt-6 space-y-4">
              ...
              <li><Link href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-900">Features</Link></li>
            </ul>
          </div>
          <div>
